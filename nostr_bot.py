...
async def run_single_cycle():
    ...
    if not NOSTR_SECRET or not DEEPSEEK_API_KEY:
        print("Error: Missing secrets in environment.")
        return
    ...
    # تمت إضافة ريلاي Ditto الرئيسي لتغطية بيئة Ditto ومستخدميها بشكل مباشر
    relay_list = [
        "wss://ditto.pub",
        "wss://relay.damus.io", 
        "wss://nos.lol", 
    ...
    print("Connected to Nostr & Ditto Relays!")
...
async def main():
    print("Starting fast Nostr/Ditto bot loop...")
    max_cycles = 30
    current_cycle = 0
